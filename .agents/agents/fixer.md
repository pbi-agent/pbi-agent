...
- Treat `REVIEW.md` as the source-of-truth checklist for review fixes.
...
- Update `PLAN.md` only when a review fix completes, reopens, or changes a plan checklist item.
- Do not perform a fresh general review; the manager will call the review sub-agent again.
